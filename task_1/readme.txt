...
Glassmorphism Design: Dark theme with translucent, blurred elements.
Category Filtering: Smoothly filters images by category (Nature, City, Architecture, Abstract).
Interactive Lightbox: Full-screen image view with navigation controls.
